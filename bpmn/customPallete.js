...
export default function CustomPalette(palette,bpmnFactory, create, elementFactory, spaceTool, lassoTool, handTool, globalConnect, moddle, translate) {
  PaletteProvider.call(this, palette,bpmnFactory, create, elementFactory, spaceTool, lassoTool, handTool, globalConnect, moddle, translate, 2000);
  this._create = create;
...
F.prototype.getPaletteEntries = function() {
  ...
  function createSignalEvent(type, group, className, title, options) {
    function createListener(event) {
  ...
  assign(actions, {
    ...
    'create.start-event-signal': createSignalEvent('bpmn:StartEvent', 'event', 'bpmn-icon-start-event-signal', translate('Create SignalStartEvent')),
...
CustomPalette.$inject = ['palette','bpmnFactory', 'create', 'elementFactory', 'spaceTool', 'lassoTool', 'handTool', 'globalConnect', 'moddle', 'translate'];
